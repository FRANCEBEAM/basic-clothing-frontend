  ...
  return (
    <>
        <div className='w-full h-full py-20 relative'>
            ...
            <div className='w-full h-[450px] flex flex-col justify-center items-center absolute z-[11]'>
                <h1 className='uppercase font-bold text-6xl text-center text-pink max-w-[600px]'>
