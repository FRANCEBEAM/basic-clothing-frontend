  ...
  return (
    <>
      <div className='w-full h-full'>
        <div className='w-full max-w-[1280px] p-3 m-auto py-36'>
          <div className='flex gap-5 items-center'>
            <h1 className='uppercase font-bold text-3xl lg:text-5xl bg-pink p-4 px-4'>Sales Men's Clothes</h1>
            <svg fill="#000000" version="1.1" id="Capa_1" width="64px" height="64px" viewBox="0 0 41.883 41.883">
              <g>
